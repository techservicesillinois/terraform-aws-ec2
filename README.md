...
specified Route 53 zone. Defaults to the value of the `name` attribute (i.e., the service name).
...
* `fqdn_alias` – A list of fully qualified domain names (if any) for each aliss created for the EC2 volume
